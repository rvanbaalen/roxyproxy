...
# Output: demo/roxyproxy-demo.cast

set -e

CAST_FILE="demo/roxyproxy-demo.cast"
...
asciinema rec "$CAST_FILE" \
  ...
  --title "RoxyProxy — The HTTP proxy your AI agent can use" \
  --cols 100 \
  --rows 30 \
  --overwrite
...
echo ""
echo "To generate GIF:  agg $CAST_FILE demo/roxyproxy-demo.gif --theme monokai --font-size 14"
